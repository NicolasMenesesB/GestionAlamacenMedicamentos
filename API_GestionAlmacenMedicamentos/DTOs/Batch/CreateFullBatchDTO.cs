...
{
    public class CreateFullBatchDTO
    {
        public string MedicationName { get; set; } = null!; // Nombre del medicamento nuevo
        public string MedicationDescription { get; set; } = null!; // Descripción del medicamento
